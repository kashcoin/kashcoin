Kashcoin-qt: Qt4 GUI for Kashcoin
===============================
...
Alternatively, install Qt Creator and open the `Kashcoin-qt.pro` file.

An executable named `Kashcoin-qt` will be built.
...
A warning for people using the *static binary* version of Kashcoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of Kashcoin is linked against libdb5.3.
...
installed causes Kashcoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
