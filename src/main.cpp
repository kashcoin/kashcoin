...
unsigned int nStakeMinAge = 12 * nOneHour; // 12 hours as zero time weight
...
const string strMessageMagic = "Kashcoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(unsigned int nBits, int64_t nFees, int nHeight)
{
	...
	if (nHeight == 1)
		return 18000000 * COIN; // 75% of available coins
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("Kashcoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Kashcoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // Kashcoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Kashcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "UK Backs Brexit as Cameron Resigns After Historic Rupture - Bloomberg - 25 June 2016";
        CTransaction txNew;
        txNew.nTime = 1466893290;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1466893300;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 38202; // !fTestNet ? 1575379 : 46534;
		
        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x3110115d24735d81c6128a3e893e3e742f1ff56e93cbe35594436389c3934df3"));
...
unsigned char pchMessageStart[4] = { 0xb8, 0xc8, 0xf2, 0xec };
