...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("KASH");
    case mBTC: return QString("mKASH");
    case uBTC: return QString::fromUtf8("μKASH");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Kashcoins"));
    case mBTC: return QString(QObject::tr("Milli-Kashcoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Kashcoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
